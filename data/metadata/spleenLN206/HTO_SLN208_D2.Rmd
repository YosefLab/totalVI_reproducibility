---
title: "Demultiplex hashtags in SLN208_D2 (Lane 13)"
...
outs_dir <- "/data/yosef2/users/zsteier/TotalSeq/20190814_BioLegend_ZRS08/cellranger_out/13_B6_spl_LN_r5_206/outs/"
...
seurat_obj <- HTODemux(seurat_obj, assay = "HTO", positive.quantile = 0.95, kfunc = "kmeans") # default is clara
...
Parameters: kmeans, 0.95 (quantile above negative cells in NB distribution)
Cutoff for HTO-B6-LN-r4-206-A0301 : 13 reads
Cutoff for HTO-B6-spl-r4-206-A0302 : 31 reads
...
# Save metadata
write_csv(tissue, "spleenLN206_day2/hashtag_labels.csv")
...
saveRDS(seurat_obj, "spleenLN206_day2/seurat_obj.rds")
...
day1 <- read_csv("/data/yosef2/users/zsteier/totalVI/totalVI_journal/notebooks_zoe/Seurat_demux/spleenLN206_day1/hashtag_labels.csv")
day2 <- read_csv("/data/yosef2/users/zsteier/totalVI/totalVI_journal/notebooks_zoe/Seurat_demux/spleenLN206_day2/hashtag_labels.csv")
