...
try:
    doublets = np.load("data/metadata/pbmc10kdoublets.npy")
    ...
    np.save("data/metadata/pbmc10kdoublets.npy", doublets)
...
adata.write("data/pbmc_10k_protein_v3.h5ad", compression="gzip")
