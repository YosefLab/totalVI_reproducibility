...
umis_sln_d1 = read.csv('data/raw_data/sln_d1_111_harmo_rna_pro.csv.gz', row.names = 1)
umis_sln_d2 = read.csv('data/raw_data/sln_d2_206_harmo_rna_pro.csv.gz', row.names = 1)
...
write.csv(integrated.data, file=gzfile("harmonization/seurat_harmo_results/seurat_d1_111_d2_206_integrated.csv.gz"))
